...
class LivenessFact:
    ...
    param_influenced_live: set[str] = field(
        default_factory=set
    )  # Live vars influenced by MCP params
    ...
    def __eq__(self, other: object) -> bool:
        ...
        if not isinstance(other, LivenessFact):
            return False
        return (
            self.live_vars == other.live_vars
            and self.param_influenced_live == other.param_influenced_live
        )
