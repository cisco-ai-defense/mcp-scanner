...
class TaintPatterns:
    ...
    COMMAND_SINKS: Dict[str, Set[str]] = field(
        default_factory=lambda: {
            "python": {
                "subprocess.run",
                "subprocess.call",
    ...
    # SQL injection sinks
    SQL_SINKS: Dict[str, Set[str]] = field(
        default_factory=lambda: {
            "python": {
                "cursor.execute",
                "cursor.executemany",
    ...
    EVAL_SINKS: Dict[str, Set[str]] = field(
        default_factory=lambda: {
            "python": {
                "eval",
                "exec",
            ...
            "javascript": {
                ...
                "new Function",
                "setTimeout",
                "setInterval",  # when passed strings
                "vm.runInContext",
                "vm.runInNewContext",
                "vm.runInThisContext",
            },
    ...
    FILE_SINKS: Dict[str, Set[str]] = field(
        default_factory=lambda: {
            "python": {
                "open",
                "file",
    ...
    # Network / SSRF sinks
    NETWORK_SINKS: Dict[str, Set[str]] = field(
        default_factory=lambda: {
            "python": {
                "requests.get",
                "requests.post",
    ...
    DESERIALIZATION_SINKS: Dict[str, Set[str]] = field(
        default_factory=lambda: {
            "python": {
                "pickle.load",
                "pickle.loads",
    ...
    SANITIZERS: Dict[str, Set[str]] = field(
        default_factory=lambda: {
            "python": {
                # Command
                "shlex.quote",
