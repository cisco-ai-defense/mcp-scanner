...
The `mcp-scanner` maintainers take all security issues in the project
seriously. Thank you for improving the security of `mcp-scanner`. We
appreciate your dedication to responsible disclosure and will make every effort
to acknowledge your contributions.

`mcp-scanner` leverages GitHub's private vulnerability reporting.
