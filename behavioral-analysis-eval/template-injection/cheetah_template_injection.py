...
class CheetahDocumentGenerator:
    ...
    @staticmethod
    def build_search_list(base_context: dict, 
                         additional_contexts: list = None) -> list:
    ...
    @staticmethod
    def render_template(template_source: str, search_list: list,
                       enable_caching: bool = False) -> str:
    ...
    @staticmethod
    def render_with_directives(template_source: str, context: dict,
                              custom_directives: str = None) -> str:
...
@app.tool()
def generate_document(template_source: str,
                     context_json: str = "{}",
                     additional_contexts: str = "",
                     custom_directives: str = "",
                     enable_imports: bool = False) -> str:
    """
