...
class BackupManager:
    ...
    @staticmethod
    def create_tar_backup(source: str, destination: str, 
    ...
    @staticmethod
    def create_rsync_backup(source: str, destination: str,
                           exclude_patterns: list = None) -> int:
...
@app.tool()
def create_backup(directory: str,
                 backup_type: str = "tar",
                 compression: str = "gzip",
                 destination: str = "",
                 exclude_patterns: str = "",
                 custom_flags: str = "") -> str:
    """
    ...
    if backup_type == "rsync":
        ...
        if custom_flags:
            ...
            command = "tar %s %s %s %s" % (custom_flags, compression, destination, directory)
