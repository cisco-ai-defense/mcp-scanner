...
'''
        ...
        assert any("requests.post" in call for call in calls), "Should detect external API call"
...
'''
        ...
        is_mismatch = ("local" in docstring.lower() or "read" in docstring.lower()) and has_external_call
...
'''
        ...
        mentions_file = any(word in docstring.lower() for word in ["file", "write", "save", "log"])
