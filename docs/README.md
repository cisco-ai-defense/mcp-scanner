...
- **[MCP Tool Detection Troubleshooting](mcp-tool-detection-troubleshooting.md)** - Why tools are missed (gate model, scan paths, workarounds)
...
- **[npm Scanning](npm-scanning.md)** - npm package scanning with JS/TS behavioral analysis (Docker or local SDK mode)
