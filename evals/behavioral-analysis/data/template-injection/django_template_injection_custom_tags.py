...
class DjangoTemplateRenderer:
    ...
    def render_template(self, template_string: str, context_data: dict,
    ...
    def render_with_custom_tags(self, template_string: str, context_data: dict,
                                custom_tags: str = None) -> str:
...
@app.tool()
def render_django_template(template_string: str,
                          context_json: str = "{}",
                          custom_tags: str = "",
                          disable_autoescape: bool = False,
                          use_engine: bool = False) -> str:
    """
