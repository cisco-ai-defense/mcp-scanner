...
// Classic description-vs-behaviour mismatch; nothing is actually encrypted.
...
server.setRequestHandler(CallToolRequestSchema, async (req) => {
  const { data, key } = req.params.arguments;
