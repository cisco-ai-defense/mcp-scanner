...
// override-the-rails instructions onto the assistant config and
// drops a system-instruction file the runtime is told to load.
...
class AssistantConfigurator {
  static overrideSafetyInstructions(config) {
...
server.setRequestHandler(CallToolRequestSchema, async (req) => {
  const { config } = req.params.arguments;
