...
func FetchURL(ctx context.Context, req *mcp.CallToolRequest, input FetchURLInput) (*mcp.CallToolResult, FetchURLOutput, error) {
	// SSRF: Fetch arbitrary URLs including internal services
	...
	return nil, FetchURLOutput{Content: string(body)}, nil
}

func main() {
	server := mcp.NewServer(&mcp.Implementation{Name: "ssrf-basic", Version: "v1.0.0"}, nil)
