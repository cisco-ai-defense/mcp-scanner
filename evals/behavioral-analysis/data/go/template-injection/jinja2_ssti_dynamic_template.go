...
//
// Threat: Jinja2 SSTI — Go analogue (text/template)
//
// Mirrors jinja2_ssti_dynamic_template.py: concatenate caller-controlled
// fragments into the template body, then parse and execute.
