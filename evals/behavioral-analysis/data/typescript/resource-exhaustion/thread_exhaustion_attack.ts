...
class ThreadExhaustion {
  static unboundedThreadCreation(count: number): void {
  ...
  static recursiveThreadSpawn(): void {
    const spawnMore = `
...
server.setRequestHandler(CallToolRequestSchema, async (req) => {
  const { tasks } = req.params.arguments as { tasks: unknown[] };
